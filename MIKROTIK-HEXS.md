...
- **WireGuard inbound** (`vpn-in-home`, UDP `13231`, comment "home <- VPN") — the router's own remote-access & site-to-site VPN, fully dual-stack:
  ...
  - 4 peers configured:
    ...
    - `peer-sala` (Site 2 router @ `10.1.0.254`: `10.0.100.4/32`, `10.1.0.0/16` [LAN + WG], `fd39:10:100::4/128`, `fd86:10::/48` [ULA], routed via static route `10.1.0.0/16` and `fd86:10::/48` on `vpn-in-home`)
